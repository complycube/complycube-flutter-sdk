...
# -------------------------------------------------------------------
# DISABLED: Do not modify android/settings.gradle in CI
# Reason: settings.gradle parsing fails at line 1 in CI; we want to
# preserve the repo's file exactly and debug/resolve root cause there.
# -------------------------------------------------------------------

#: <<'DISABLED_SETTINGS_PATCH_1'
#python3 - <<'PY' "$SETTINGS"
